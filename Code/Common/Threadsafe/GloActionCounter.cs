...
/*
GloActionCounter: An approach that uses atomic operations with Interlocked to ensure thread safety
...
public class GloActionCounter
{
    private int _count;

    public GloActionCounter(int initialCount)
    {
        _count = initialCount;
    }
