...
// GloLimitedConcurrentQueue Class to store new values up to a set capacity, then remove oldest element on the arrival of new ones.
// Can return the list population count, list and latest values.

public class GloLimitedConcurrentQueue<T>
{
    ...
    public GloLimitedConcurrentQueue(int capacity)
    {
