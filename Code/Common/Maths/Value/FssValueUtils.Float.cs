...
// FssValueUtils: A static class for common (float precision) math routines, useful as helper routines for higher-level functionality.
...
public static partial class FssValueUtils
{
    ...
    {
        if (Math.Abs(rangesize) < FssConsts.ArbitraryMinFloat)
