...
public static class FssLLAPointOperations
{
    public static FssLLAPoint RhumbLineInterpolation(FssLLAPoint fromPoint, FssLLAPoint toPoint, double fraction)
    {
        ...
        return new FssLLAPoint() { LatDegs = latDegs, LonDegs = lonDegs, AltMslM = alt };
    }
    ...
    public static FssLLAPoint GreatCircleInterpolation(FssLLAPoint fromPoint, FssLLAPoint toPoint, double fraction)
    {
