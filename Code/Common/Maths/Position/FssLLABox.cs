...
// FssLLABox: Class to represent a 3D box, curving to a spherical surface. Deals with points
...
public struct FssLLABox
{
    ...
    public double ArcLonRads
    {
        get { return MaxLonRads - MinLonRads; }
    }
    public double ArcLatDegs
    {
        get { return MaxLatDegs - MinLatDegs; }
    }
    public double ArcLonDegs
    {
