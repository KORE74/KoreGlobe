...
public static partial class GloNumeric1DArrayOperations<T> where T : struct, INumber<T>
{
    ...
    public static T CalculateBezierPoint(T t, GloNumeric1DArray<T> controlPoints)
    {
    ...
    public static GloNumeric1DArray<T> CalculateBezierFirstDerivative(T t, GloNumeric1DArray<T> controlPoints)
    {
        switch (controlPoints.Length)
        {
            case 3:
    ...
    public static GloNumeric1DArray<T> CalculateBezierSecondDerivative(T t, GloNumeric1DArray<T> controlPoints)
    {
        switch (controlPoints.Length)
        {
            case 3:
    ...
    private static T CalculateBezier3Point(T t, GloNumeric1DArray<T> controlPoints)
    {
        T u  = T.One - t;
        T tt = t * t;
        T uu = u * u;
    ...
    private static GloNumeric1DArray<T> CalculateBezier3PointFirstDerivative(T t, GloNumeric1DArray<T> controlPoints)
    {
        T dx = T.CreateChecked(2) * (T.One - t) * (controlPoints[1] - controlPoints[0]) +
                T.CreateChecked(2) * t * (controlPoints[2] - controlPoints[1]);

        return new GloNumeric1DArray<T>(new T[] { dx });
    }

    private static GloNumeric1DArray<T> CalculateBezier3PointSecondDerivative(GloNumeric1DArray<T> controlPoints)
    {
    ...
    private static T CalculateBezier4Point(T t, GloNumeric1DArray<T> controlPoints)
    {
        T u   = T.One - t;
        T tt  = t * t;
        T uu  = u * u;
    ...
    private static GloNumeric1DArray<T> CalculateBezier4PointFirstDerivative(T t, GloNumeric1DArray<T> controlPoints)
    {
    ...
    private static GloNumeric1DArray<T> CalculateBezier4PointSecondDerivative(T t, GloNumeric1DArray<T> controlPoints)
    {
    ...
    private static T CalculateBezier5Point(T t, GloNumeric1DArray<T> controlPoints)
    {
        T u    = T.One - t;
        T tt   = t * t;
        T uu   = u * u;
    ...
    private static GloNumeric1DArray<T> CalculateBezier5PointFirstDerivative(T t, GloNumeric1DArray<T> controlPoints)
    {
    ...
    private static GloNumeric1DArray<T> CalculateBezier5PointSecondDerivative(T t, GloNumeric1DArray<T> controlPoints)
    {
