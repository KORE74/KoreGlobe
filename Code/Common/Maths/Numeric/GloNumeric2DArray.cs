...
public partial class GloNumeric2DArray<T> where T : struct, INumber<T>
{
    ...
    public GloNumeric2DArray(int width, int height)
    {
        if (width < 1 || height < 1)
    ...
    public GloNumeric2DArray(T[,] initialData)
    {
    ...
    public GloNumeric2DArray(GloNumeric2DArray<T> other)
    {
        Width  = other.Width;
        Height = other.Height;
        Data   = new T[Width, Height];
    ...
    public GloNumeric2DArray<T> Scale(T newMin, T newMax)
    {
        T oldMin   = MinVal();
        T oldMax   = MaxVal();
        ...
        GloNumeric2DArray<T> scaledArray = new GloNumeric2DArray<T>(Width, Height);
    ...
    public GloNumeric2DArray<T> Transpose()
    {
        GloNumeric2DArray<T> transposed = new GloNumeric2DArray<T>(Height, Width);
    ...
    public GloNumeric2DArray<T> ReverseRows()
    {
        GloNumeric2DArray<T> reversed = new GloNumeric2DArray<T>(Width, Height);
    ...
    public GloNumeric2DArray<T> ReverseCols()
    {
        GloNumeric2DArray<T> reversed = new GloNumeric2DArray<T>(Width, Height);
