...
public static class FssFloatDataSetIO
{
    public static string ToCSVString(FssFloatDataSet dataSet, int decimalPlaces)
    {
    ...
    public static FssFloatDataSet FromCSVString(string csvString)
    {
        string[] lines = csvString.Trim().Split(new[] { '\n' }, StringSplitOptions.RemoveEmptyEntries);
        FssFloatDataSet dataSet = new FssFloatDataSet();
    ...
    public static void SaveToCSVFile(FssFloatDataSet dataSet, string filePath, int decimalPlaces)
    {
        string csvString = ToCSVString(dataSet, decimalPlaces);
        File.WriteAllText(filePath, csvString);
    }

    public static FssFloatDataSet LoadFromCSVFile(string filePath)
    {
        string csvString = File.ReadAllText(filePath);
        return FromCSVString(csvString);
    }

    public static void SaveToBinaryFile(FssFloatDataSet dataSet, string filePath)
    {
    ...
    public static FssFloatDataSet LoadFromBinaryFile(string filePath)
    {
