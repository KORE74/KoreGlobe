...
public static class FssXYZPointOperations
{
    ...
    public static double DotProduct(FssXYZPoint a, FssXYZPoint b)
    {
    ...
    public static FssXYZPoint CrossProduct(FssXYZPoint a, FssXYZPoint b)
    {
    ...
    public static double AngleBetweenRads(FssXYZPoint a, FssXYZPoint b)
    {
    ...
    {
        FssXYZPoint vecA = a - origin;
        FssXYZPoint vecB = b - origin;
    ...
    // usage: FssXYZPoint a = new FssXYZPoint(1, 2, 3);
    //        FssXYZPoint c = FssXYZPointOperations.OffsetAzEl(a, 10, FssValueUtils.DegsToRads(45), FssValueUtils.DegsToRads(30));

    public static FssXYZPoint OffsetAzEl(FssXYZPoint origin, double radius, double azimuthRads, double elevationRads)
    {
    ...
    public static FssXYZPoint Slerp(FssXYZPoint a, FssXYZPoint b, double fraction)
    {
        // Handle edge cases
        ...
        if (Math.Abs(angle) < FssConsts.ArbitraryMinDouble)
        ...
        // Calculate the interpolated point
        FssXYZPoint interpolated = (a * sinComplementAngle + b * sinFractionAngle) / sinAngle;
    ...
    public static FssXYZPoint InsetPoint(FssXYZPoint a, FssXYZPoint b, FssXYZPoint c, double t)
    {
        ...
        return new FssXYZPoint(xInset, yInset, zInset);
    }

    // --------------------------------------------------------------------------------------------

    public static FssXYZPoint RotateAboutAxis(FssXYZPoint point, FssXYZPoint axis, double angleRads)
    {
        ...
        return new FssXYZPoint(newX, newY, newZ);
    }
