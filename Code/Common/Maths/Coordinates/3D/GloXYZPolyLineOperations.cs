...
public static class GloXYZPolyLineOperations
{
    // 3 point Bezier curve in 3D
    public static GloXYZPoint Calculate3PointBezierPos(double t, GloXYZPoint start, GloXYZPoint control, GloXYZPoint end)
    {
        double u = 1 - t;
        double tt = t * t;
        double uu = u * u;
    ...
    public static GloXYZPoint Calculate3PointBezierFirstDerivative(GloXYZPoint start, GloXYZPoint control, GloXYZPoint end, double t)
    {
        ...
        return new GloXYZPoint(dx, dy, dz);
    }

    // Second derivative in 3D
    public static GloXYZPoint Calculate3PointBezierSecondDerivative(GloXYZPoint start, GloXYZPoint control, GloXYZPoint end, double t)
    {
        return new GloXYZPoint(2 * (end.X - 2 * control.X + start.X), 2 * (end.Y - 2 * control.Y + start.Y), 2 * (end.Z - 2 * control.Z + start.Z));
    }

    // --------------------------------------------------------------------------------------------

    // 4 point Bezier curve in 3D
    public static GloXYZPoint Calculate4PointBezierPos(double t, GloXYZPoint start, GloXYZPoint control1, GloXYZPoint control2, GloXYZPoint end)
    {
        double u = 1 - t;
        double tt = t * t;
        double uu = u * u;
    ...
    public static GloXYZPoint Calculate4PointBezierFirstDerivative(GloXYZPoint start, GloXYZPoint control1, GloXYZPoint control2, GloXYZPoint end, double t)
    {
    ...
    // Second derivative in 3D
    public static GloXYZPoint Calculate4PointBezierSecondDerivative(GloXYZPoint start, GloXYZPoint control1, GloXYZPoint control2, GloXYZPoint end, double t)
    {
    ...
    // Creating a 3D Bezier polyline remains conceptually similar, just working with GloXYZPoint instead of GloXYPoint
