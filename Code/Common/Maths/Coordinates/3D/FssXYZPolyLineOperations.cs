...
public static class FssXYZPolyLineOperations
{
    // 3 point Bezier curve in 3D
    public static FssXYZPoint Calculate3PointBezierPos(double t, FssXYZPoint start, FssXYZPoint control, FssXYZPoint end)
    {
        double u = 1 - t;
        double tt = t * t;
        double uu = u * u;
    ...
    public static FssXYZPoint Calculate3PointBezierFirstDerivative(FssXYZPoint start, FssXYZPoint control, FssXYZPoint end, double t)
    {
        ...
        return new FssXYZPoint(dx, dy, dz);
    }

    // Second derivative in 3D
    public static FssXYZPoint Calculate3PointBezierSecondDerivative(FssXYZPoint start, FssXYZPoint control, FssXYZPoint end, double t)
    {
        return new FssXYZPoint(2 * (end.X - 2 * control.X + start.X), 2 * (end.Y - 2 * control.Y + start.Y), 2 * (end.Z - 2 * control.Z + start.Z));
    }

    // 4 point Bezier curve in 3D
    public static FssXYZPoint Calculate4PointBezierPos(double t, FssXYZPoint start, FssXYZPoint control1, FssXYZPoint control2, FssXYZPoint end)
    {
        double u = 1 - t;
        double tt = t * t;
        double uu = u * u;
    ...
    public static FssXYZPoint Calculate4PointBezierFirstDerivative(FssXYZPoint start, FssXYZPoint control1, FssXYZPoint control2, FssXYZPoint end, double t)
    {
    ...
    // Second derivative in 3D
    public static FssXYZPoint Calculate4PointBezierSecondDerivative(FssXYZPoint start, FssXYZPoint control1, FssXYZPoint control2, FssXYZPoint end, double t)
    {
    ...
    // Creating a 3D Bezier polyline remains conceptually similar, just working with FssXYZPoint instead of FssXYPoint
