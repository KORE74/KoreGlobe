...
public static partial class FssNumeric1DArrayOperations<T> where T : struct, INumber<T>
{
    // --------------------------------------------------------------------------------------------
    // MARK: Bezier functions
    // --------------------------------------------------------------------------------------------

    public static T CalculateBezierPoint(T t, FssNumeric1DArray<T> controlPoints)
    {
    ...
    public static FssNumeric1DArray<T> CalculateBezierFirstDerivative(T t, FssNumeric1DArray<T> controlPoints)
    {
        switch (controlPoints.Length)
        {
            case 3:
    ...
    public static FssNumeric1DArray<T> CalculateBezierSecondDerivative(T t, FssNumeric1DArray<T> controlPoints)
    {
        switch (controlPoints.Length)
        {
            case 3:
    ...
    private static T CalculateBezier3Point(T t, FssNumeric1DArray<T> controlPoints)
    {
        T u  = T.One - t;
        T tt = t * t;
        T uu = u * u;
    ...
    private static FssNumeric1DArray<T> CalculateBezier3PointFirstDerivative(T t, FssNumeric1DArray<T> controlPoints)
    {
        T dx = T.CreateChecked(2) * (T.One - t) * (controlPoints[1] - controlPoints[0]) +
                T.CreateChecked(2) * t * (controlPoints[2] - controlPoints[1]);

        return new FssNumeric1DArray<T>(new T[] { dx });
    }

    private static FssNumeric1DArray<T> CalculateBezier3PointSecondDerivative(FssNumeric1DArray<T> controlPoints)
    {
    ...
    private static T CalculateBezier4Point(T t, FssNumeric1DArray<T> controlPoints)
    {
        T u   = T.One - t;
        T tt  = t * t;
        T uu  = u * u;
    ...
    private static FssNumeric1DArray<T> CalculateBezier4PointFirstDerivative(T t, FssNumeric1DArray<T> controlPoints)
    {
    ...
    private static FssNumeric1DArray<T> CalculateBezier4PointSecondDerivative(T t, FssNumeric1DArray<T> controlPoints)
    {
    ...
    private static T CalculateBezier5Point(T t, FssNumeric1DArray<T> controlPoints)
    {
        T u    = T.One - t;
        T tt   = t * t;
        T uu   = u * u;
    ...
    private static FssNumeric1DArray<T> CalculateBezier5PointFirstDerivative(T t, FssNumeric1DArray<T> controlPoints)
    {
    ...
    private static FssNumeric1DArray<T> CalculateBezier5PointSecondDerivative(T t, FssNumeric1DArray<T> controlPoints)
    {
