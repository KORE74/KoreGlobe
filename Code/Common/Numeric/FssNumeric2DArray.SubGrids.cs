...
{
    public FssNumeric2DArray<T> GetInterpolatedGrid(int inNewSizeX, int inNewSizeY)
    {
        FssNumeric2DArray<T> retGrid = new FssNumeric2DArray<T>(inNewSizeX, inNewSizeY);
    ...
    public FssNumeric2DArray<T> GetSubgrid(int startX, int startY, int subgridWidth, int subgridHeight)
    {
        ...
        FssNumeric2DArray<T> outGrid = new FssNumeric2DArray<T>(subgridWidth, subgridHeight);
    ...
    public FssNumeric2DArray<T> GetInterpolatedSubgrid(Fss2DGridPos gridPos, int subgridWidth, int subgridHeight)
    {
        int totalSubgridWidth  = gridPos.Width * subgridWidth;
        int totalSubgridHeight = gridPos.Height * subgridHeight;

        FssNumeric2DArray<T> interpolatedGrid = GetInterpolatedGrid(totalSubgridWidth, totalSubgridHeight);
    ...
    public FssNumeric2DArray<T>[,] GetInterpolatedSubGridCellWithOverlap(int inNumSubgridCols, int inNumSubgridRows, int inSubgridSizeX, int inSubgridSizeY)
    {
        ...
        FssNumeric2DArray<T>[,] subGrid = new FssNumeric2DArray<T>[inNumSubgridCols, inNumSubgridRows];
