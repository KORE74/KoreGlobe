...
public static class GloColorConv
{
    // --------------------------------------------------------------------------------------------
    // MARK: HSV RGB
    // --------------------------------------------------------------------------------------------

    public static GloColorHSV HSVtoRGB(GloColorRGB rgb)
    {
        float r = rgb.R / 255f;
        float g = rgb.G / 255f;
        float b = rgb.B / 255f;
        ...
        return new GloColorHSV(h, s, v, rgb.A);
    }

    public static GloColorRGB HSVtoRGB(GloColorHSV hsv)
    {
        float r, g, b;
