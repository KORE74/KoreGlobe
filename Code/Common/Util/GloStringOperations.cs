...
public static class GloStringOperations
{
    ...
    // Usage: int index = GloStringOperations.NumberForLetter('a');
    ...
    // Usage: bool isTrue = GloStringOperations.BoolForString("true");
    ...
    // Usage: int seconds = GloStringOperations.TimeHmsToSeconds("01:23:45");
