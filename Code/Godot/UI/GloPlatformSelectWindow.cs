...
public partial class GloPlatformSelectWindow : Window
{
    ...
    {
        Title             = GloLanguageStrings.Instance.GetParam("SelectPlatform");
        SelectButton.Text = GloLanguageStrings.Instance.GetParam("Select");
