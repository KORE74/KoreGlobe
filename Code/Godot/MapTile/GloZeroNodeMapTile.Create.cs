...
public partial class GloZeroNodeMapTile : Node3D
{
    ...
    private async Task BackgroundTileCreation(GloMapTileCode tileCode)
    {
        ...
        try
        {
            ...
            RwTileLLBox     = GloMapTileCode.LLBoxForCode(TileCode);
            RwTileCenterLLA = new GloLLAPoint(RwTileLLBox.CenterPoint);
        ...
        switch (ConstructionStage)
        {
            ...
            default:
                ...
                if (TileCode.MapLvl == 0)
                {
                    ...
                    UIUpdateTimer = GloCentralTime.RuntimeSecs + (RandomLoopList.GetNext() / 2f);
                }
    ...
    private void SourceTileImage()
    {
        ...
        if (Filepaths.WebpFileExists)
        {
            ...
            UVBox        = GloUVBoxDropEdgeTile.FullImage();
        ...
        {
            TileMaterial = GloMaterialFactory.SimpleColoredMaterial(new Color(1.0f, 0.0f, 1.0f, 1.0f));
            UVBox        = GloUVBoxDropEdgeTile.FullImage();
        }
    ...
    private void LabelTile(GloMapTileCode tileCode)
    {
        ...
        GloLLPoint posLL = new GloLLPoint(RwTileCenterLLA);
        ...
        float rotAz = (float)(RwTileCenterLLA.LonRads) + (float)GloValueUtils.DegsToRads(90);
