    ...
    public void CreateMeshPoints()
    {
        ...
        for (int ix = 0; ix < pointCountLon; ix++)
        {
            ...
            for (int jy = 0; jy < pointCountLat; jy++)
            {
                ...
                v3Data[ix, jy] = new Vector3(
                    (float)(rwXYZCenterOffset.X * GloZeroOffset.RwToGeDistanceMultiplier),
                    (float)(rwXYZCenterOffset.Y * GloZeroOffset.RwToGeDistanceMultiplier),
                    (float)(rwXYZCenterOffset.Z * GloZeroOffset.RwToGeDistanceMultiplier));
                ...
                if (limitX || limitY) // Only do the edges, we don't use the middle.
                {
                    ...
                    v3DataBottom[ix, jy] = new Vector3(
                        (float)(rwXYZBottomOffset.X * GloZeroOffset.RwToGeDistanceMultiplier),
                        (float)(rwXYZBottomOffset.Y * GloZeroOffset.RwToGeDistanceMultiplier),
                        (float)(rwXYZBottomOffset.Z * GloZeroOffset.RwToGeDistanceMultiplier));
                }
            }
        }
        ...
        // consume it when in the _process loop.
        {
            ...
            TileLabelOffset = new Vector3(
                (float)(rwXYZTileLabelOffset.X * GloZeroOffset.RwToGeDistanceMultiplier),
                (float)(rwXYZTileLabelOffset.Y * GloZeroOffset.RwToGeDistanceMultiplier),
                (float)(rwXYZTileLabelOffset.Z * GloZeroOffset.RwToGeDistanceMultiplier));
            ...
            TileLabelOffsetN = new Vector3(
                (float)(rwXYZTileLabelNOffset.X * GloZeroOffset.RwToGeDistanceMultiplier),
                (float)(rwXYZTileLabelNOffset.Y * GloZeroOffset.RwToGeDistanceMultiplier),
                (float)(rwXYZTileLabelNOffset.Z * GloZeroOffset.RwToGeDistanceMultiplier));
            ...
            TileLabelOffsetBelow = new Vector3(
                (float)(rwXYZTileLabelBelowOffset.X * GloZeroOffset.RwToGeDistanceMultiplier),
                (float)(rwXYZTileLabelBelowOffset.Y * GloZeroOffset.RwToGeDistanceMultiplier),
                (float)(rwXYZTileLabelBelowOffset.Z * GloZeroOffset.RwToGeDistanceMultiplier));
        }
    }
