...
//         else
//         {
//             GloCentralLog.AddEntry($"KoreGodotEntityManager.EnableChaseCam: Entity not found: {platName}");

//             List<string> entnames = EntityNames();
//             GloCentralLog.AddEntry($"KoreGodotEntityManager.EnableChaseCam: Available entities: {string.Join(", ", entnames)}");
