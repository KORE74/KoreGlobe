...
//     //     FocusPos = KoreGeoConvOperations.RealWorldToGodotRads((float)FocusOffsetDist, (float)latRads,     (float)lonRads);
//     //     CorePos  = KoreGeoConvOperations.RealWorldToGodotRads((float)CoreOffsetDist,  (float)backLatRads, (float)backLonRads);
//     // }
