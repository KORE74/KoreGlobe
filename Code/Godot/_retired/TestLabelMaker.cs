...
//         float distance = (float)(KoreZeroOffset.GeEarthRadius) + 0.1f;
...
//                 GloLLAPoint pos  = new GloLLAPoint() { LatDegs = lat, LonDegs = lon, RadiusM = KoreZeroOffset.GeEarthRadius };
//                 GloLLAPoint posN = new GloLLAPoint() { LatDegs = lat + 0.01, LonDegs = lon, RadiusM = KoreZeroOffset.GeEarthRadius };
