...
// public partial class GloTestCylinder2 : Node3D
// {
//     // Called when the node enters the scene tree for the first time.
//     public override void _Ready()
//     {
//         GloCentralLog.AddEntry("TestCylinder2 // _Ready");
...
//                 //Vector3 position      = KoreGeoConvOperations.RealWorldToGodot(distance, lat, lon);
//                 //Vector3 northPosition = KoreGeoConvOperations.RealWorldToGodot(distance, lat + 1, lon);
//                 //Vector3 eastPosition  = KoreGeoConvOperations.RealWorldToGodot(distance, lat, lon + lonInc);
//                 //Vector3 southPosition = KoreGeoConvOperations.RealWorldToGodot(distance, lat - latInc, lon);
...
//         cylinder.MaterialOverride = GloMaterialFactory.SimpleColoredMaterial(new Color(0.0f, 0.5f, 1.0f, 1.0f));
