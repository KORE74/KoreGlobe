...
public partial class GloMeshBuilder
{
    ...
    public void AddPyramidByAzElDist(GloAzElBox azElBox, float baseDist)
    {
        Vector3 apex       = new Vector3(0, 0, 0); // Apex of the pyramid
    ...
    public void AddCroppedPyramidByAzElDist(GloAzElBox azElBox, float topDist, float baseDist)
    {
        Vector3 apex = new Vector3(0, 0, 0); // Apex of the pyramid
