...
public partial class GloLineMesh3D : Node3D
{
    ...
    public void AddPyramidByAzElDist(GloAzElBox azElBox, float baseDist, Color lineColor, PyramidStyle drawStyle = PyramidStyle.Pyramid)
    {
        Vector3 apex = new Vector3(0, 0, 0); // Apex of the pyramid
    ...
    public void AddCroppedPyramidByAzElDist(GloAzElBox azElBox, float topDist, float baseDist, Color lineColor)
    {
        Vector3 apex = new Vector3(0, 0, 0); // Apex of the pyramid
