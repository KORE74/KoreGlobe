...
public static class GloMaterialFactory
{
    // --------------------------------------------------------------------------------------------
    ...
    // Usage:
    //   meshInstance.MaterialOverride = GloMaterialFactory.WireframeMaterial(GloColorUtil.Colors["White"]);
    ...
    // Usage: meshInstance.MaterialOverride = GloMaterialFactory.WaterMaterial();
