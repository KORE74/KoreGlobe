...
//         GloCentralLog.AddEntry("Stopping console interface...");
...
//         if (MapData != null)
//         {
//             GloCentralLog.AddEntry($"SetRootDir: {MapData.RootDir}");
//         }
//     }
...
//         {
//             GloCentralLog.AddEntry("CreateTileEle: Empty tilecodeStr");
//             return;
//         }
//         if ((tilecodeStr.Length < 2) || (tilecodeStr.Length > 20))
//         {
//             GloCentralLog.AddEntry($"CreateTileEle: Invalid tilecodeStr length: >{tilecodeStr}<");
//             return;
//         }
