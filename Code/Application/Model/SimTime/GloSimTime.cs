...
public class GloSimTime
{
    ...
    public string SimTimeHMS
    {
        ...
        set
        {
            ...
            if (isRunning) Stop();
            int seconds = GloStringOperations.TimeHmsToSeconds(value);
    ...
    public void SetSimRate(double newSimRate)
    {
        ...
        newSimRate = GloValueUtils.ClampD(newSimRate, 0.1, 10);
        if (!GloValueUtils.EqualsWithinTolerance(newSimRate, SimRate))
        {
