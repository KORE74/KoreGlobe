...
// GlobePlatformRoute: Class representing a series of move instructions. Getting the desired position for a point in time can inform move
...
public abstract class GlobePlatformRoute
{
    public string Name { set; get; } = "unnamed-route";

    public abstract GlobeLLA PositionForTime(float simulationTimeSecs);
}
