...
namespace GloJSON
{
    public class BeamLoad : JSONMessage
    {
        ...
        {
            get { return (DetectionRangeMtrs * GloWorldConsts.MetresToKmMultiplier); }
            set { DetectionRangeMtrs = (value * GloWorldConsts.KmToMetresMultiplier); }
        }

        [JsonIgnore]
        public double DetectionRangeRxKms
        {
            get { return (DetectionRangeRxMtrs * GloWorldConsts.MetresToKmMultiplier); }
            set { DetectionRangeRxMtrs = (value * GloWorldConsts.KmToMetresMultiplier); }
        }

        [JsonIgnore]
        public GloAttitude PortAttitude
        {
            get { return new GloAttitude() { RollClockwiseDegs = PortRollDegs, PitchUpDegs = PortPitchDegs, YawClockwiseDegs = PortYawDegs }; }
            set
            {
